...
Measurability is enabled by the "Response Measure field".
...
\defn{Loose Coupling Dimensions}{
    ...
    \begin{itemize}
        \item Reference autonomy. Producers and consumers dont know each other.
        \item Platform autonomy. Producers and consumers may be located in different technical environments (e.g., 
        containers), can be written in different languages, etc.
        ...
        \item Format autonomy. Producers and consumers may use different formats of data exchanged.
    \end{itemize}
}
...
\defn{REST}{
    ...
    \begin{itemize}
        ...
        \item Representations (external view)
        \item Unified method set
    \end{itemize}
    Resources have representations, which does not imply data- and CRUD-orientation.
    REST is defined by four interface constraints: 
\begin{itemize}
    \item identification of resources; 
    \item manipulation of resources through representations; 
    \item self-descriptive messages; and, 
